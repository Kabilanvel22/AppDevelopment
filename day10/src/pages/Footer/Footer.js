       ...
       <div className="footer-container">
           <div className="footer-web">
                <div className="footer-logo">
                   ...
                   <p className="footer-infos">Our mission is simple: Nurturing Nature, One Plant at a Time. <br/>We believe that even the smallest green space has the potential<br/> to blossom into a thriving oasis. From seasoned gardeners to<br/> those just starting their journey, Little Garden is here to inspire<br/> and support every step of the way. Join us in this collective<br/> effort to nurture nature and create vibrant, living landscapes that<br/> enrich our lives and the environment.</p>
                </div>
                <div className="footer-social">
                    <h3 className="footer-follow">Follow us</h3>
                    <i class="fab fa-instagram"  id="footer-social-media" onClick={handleinsta}></i>
                    <i class="fab fa-twitter"  id="footer-social-media" onClick={handletwit}></i>
                    <i class="fab fa-facebook"  id="footer-social-media" onClick={handleface}></i>
                </div>
           </div>
              ...
              <div className="footer-newsletter-head">
                  ...
                  <div className="fo-news-form">
                     <form className="fo-forms">
                         <input className="fo-mail"
                            type="email" placeholder="Email Address"/>
                            <button className="fo-mail-btn" onClick={handleClick}><i class="fab fa-telegram-plane" id="fo-mail-icon"></i></button>
                     </form>
                  </div>
              </div>
           </div>
