...
function PumpkinGrowing() {
  return (
    ...
    <main className="plant-main">
      <h4 className="plant-header">A Comprehensive Guide to Growing Pumpkin</h4>

      <div className="plant-section">
        <span  className="plant-header-sub"><i className="fas fa-sun"></i> Position</span>
        <p className="plant-para">Pumpkin plants require a sunny, sheltered position.</p>
      </div>

      <div className="plant-section">
        <span className="plant-header-sub"><i className="fas fa-snowflake"></i> Frost Tolerant</span>
        <p className="plant-para">No, Pumpkin plants are not frost tolerant.</p>
      </div>

      <div className="plant-section">
        <span className="plant-header-sub"><i className="fas fa-arrows-alt-h"></i> Spacing</span>
        <p className="plant-para">Plant your Pumpkin plants around 40cm apart.</p>
      </div>

      <div className="plant-section">
        <span className="plant-header-sub"><i className="fas fa-seedling"></i> Planting</span>
        <p className="plant-para">
          Pumpkin are warm season crops that are best grown in temperatures between 18 and 30°C (65–86°F).
          Sow Pumpkin seeds indoors in late winter and transplant seedlings outdoors in spring, once the danger of frost has passed.
      ...
      <div className="plant-section">
        ...
        <p className="plant-para">Apply an organic fertiliser to your Pumpkin plants throughout the season.</p>
      </div>
      ...
      <div className="plant-section">
        ...
        <p className="plant-para">Pests that affect Pumpkin plants include: Aphids, Slug, Snail, Fruit Fly, Spider Mites, Thrips, Root Knot Nematodes, Flea Beetle, Armyworm, Leafroller, Leafminer, Pepper Weevil, Tomato Fruit Worm.</p>
      </div>

      <div className="plant-section">
        <span className="plant-header-sub"><i className="fas fa-biohazard"></i> Diseases</span>
        <p className="plant-para">Diseases that affect Pumpkin plants include: Aphids, Slug, Snail, Mosaic Virus, Leaf Spot, Blight, Verticillium wilt, Fusarium Wilt, Powdery Mildew.</p>
      </div>

      <div className="plant-section">
        <span className="plant-header-sub"><i className="fas fa-sticky-note"></i> Notes</span>
        <p className="plant-para">Pumpkin plants may require staking for support.</p>
      </div>
      </main>
    </div>
    <Footer/>
